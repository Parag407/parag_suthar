...
const timelineData = [
  ...
  },
  {
    ...
    icon: '🥇',
    tag: '1st Place',
    title: '2nd Runner-Up — Sankalp Fest, Lala Lajpat Rai College',
    org: 'Lala Lajpat Rai College, Mumbai',
    desc: 'Secured 2nd Runner-Up position in Digital Poster Making at the Sankalp Fest, demonstrating exceptional creativity.',
    highlights: ['2nd Runner-Up', 'Digital Poster Making'],
    imgFile: 'sankalp_lalas_college.png',
    imgPlaceholder: 'Digital Poster Making',
    color: '#FFD700',
  },
  {
    year: '2025',
    ...
    desc: 'Won First Runner-Up at the Pixarel Digital Poster Design competition at NM College\'s prestigious Technotsav tech festival.',
  ...
  },
  {
    ...
    highlights: ['React JS • Node JS • MongoDB', 'Full Product Lifecycle'],
    imgFile: 'gyancode_launch.png',
  ...
  },
  {
    ...
    imgFile: 'corporate-clash-esummit.jpeg',
