...
const timelineData = [
  ...
  },
  {
    ...
    icon: '🥇',
    tag: '1st Place',
    title: '2nd Prize — Sankalp Fest, Lala Lajpat Rai College',
    org: 'Lala Lajpat Rai College, Mumbai',
    desc: 'Secured 2nd Prize position in Digital Poster Making at the Sankalp Fest, demonstrating exceptional creativity.',
    highlights: ['2nd Prize', 'Digital Poster Making'],
